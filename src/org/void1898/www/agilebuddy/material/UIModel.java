...
public class UIModel {
    ...
    // 随机数生成器
    private Random mRan = new Random(MessageDefinition.HOST.hashCode());
    ...
    // 主角X方向移动速度
    public int mRoleVelocityX;

    // 主角Y方向移动速度
    public int mRoleVelocityY;
    // 附加速度(用于控制速度,在选项面板里设定)
    public int mAddVelocity;
    ...
    public int mFootboardSpaceFactor = 120 * GAME_ATTRIBUTE_PIXEL_DENSITY_Y;

    // 移动间隔计算器
    public int mFootboardSpaceCounter = 0;

    // 踏板移动速度
    public int mFootboartVelocity = -3 * GAME_ATTRIBUTE_PIXEL_DENSITY_Y;

    // 踏板列表
    public LinkedList<Footboard> mFootboardList;

    public Food mCurFood;
